...
func newInadmissibleWorkloadRequeuer() *controllerRequeuer {
	return NewInadmissibleWorkloadRequeuerWithBatchPeriod(requeueBatchPeriodProd)
}

func NewInadmissibleWorkloadRequeuerWithBatchPeriod(batchPeriod time.Duration) *controllerRequeuer {
